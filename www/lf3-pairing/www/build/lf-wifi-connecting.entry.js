...
const LfWifiConnecting = class {
  ...
  renderConnectingStatus() {
    switch (this.connectionStatus) {
      ...
      case ConnectionStatus.Successful:
        return (h("img", { src: LfConf.imageHost + "/icons/checkmark--rounded-green.svg", class: "wifi-connecting--status-icon success-icon animation--pop-in", style: { "--animation-order": 1 } }));
      case ConnectionStatus.Failed:
        return (h("img", { src: LfConf.imageHost + "/icons/x--flat-red.svg", class: "wifi-connecting--status-icon failed-icon animation--pop-in", style: { "--animation-order": 1 } }));
    }
  }
  renderStatusMsg() {
  ...
  render() {
    return (h("div", { class: "wifi-connecting--container" }, h("div", { class: "wifi-connecting--status-container animation--pop-in", style: { "--animation-order": 1 } }, h("div", { class: "wifi-connecting--points" }, h("div", { class: "wifi-connecting--img-frame" }, h("img", { src: LfConf.imageHost + "/logos/Logomark Black@60px.svg", class: "wifi-connecting--img" })), h("p", null, "Lightform")), h("div", { class: "wifi-connecting--status-wrapper" }, this.renderConnectingStatus()), h("div", { class: "wifi-connecting--points" }, h("div", { class: "wifi-connecting--img-frame" }, h("img", { src: LfConf.imageHost + "/icons/globe.svg", class: "wifi-connecting--img" })), h("p", null, "Internet"))), h("div", { class: "wifi-connecting--status-msg-container animation--pop-in", style: { "--animation-order": 2 } }, this.renderStatusMsg()), h("div", { class: "wifi-connecting--action-btn-container animation--pop-in", style: { "--animation-order": 3 } }, h("div", { onClick: (e) => this.onConnectionBtnClick(e), ref: el => (this.connectionActionBtn = el), class: "wifi-connecting--action-btn wifi-list-item", tabindex: "0" }, h("div", { class: "action-btn--text" }, this.connectionStatus === ConnectionStatus.Connecting ? "Cancel" : "OK")))));
  }
};
