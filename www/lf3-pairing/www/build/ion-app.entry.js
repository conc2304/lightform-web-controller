import { r as registerInstance, n as Build, h, j as Host, k as getElement } from './index-999ee693.js';
import { a as isPlatform, c as config, g as getIonMode } from './ionic-global-6b067d39.js';
    ...
    if (Build.isBrowser) {
      rIC(() => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-bb815996.js').then(module => module.startStatusTap());
        }
