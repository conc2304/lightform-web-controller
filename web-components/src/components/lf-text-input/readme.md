...
| `labelPosition`   | `label-position`    | The position determines where and how the label behaves inside an item. Defaults to fixed if label is set.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `"fixed" \| "stacked" \| "stacked-centered"`                                                                                                           | `undefined`    |
